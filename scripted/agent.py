...
class SmartAgent(object):
    ...
    def step(self, obs):
        ...
        enemy_loc, player_loc, distance, selected, enemy_count, player_hp, enemy_hp = self.extract_features(obs)
    ...
    def extract_features(self, obs):
        ...
        return enemy, player, sel_distance[0], is_selected, enemy_unit_count, player_hp, enemy_hp
    ...
    def plot_hp(self, path, save):
        ...
        print("AVG Player HP LEFT", sum(self.leftover_player_hp) / len(self.leftover_player_hp))
        print("Winning Rate: {0:.2f}%".format(float(self.win / (self.episodes - 1) * 100)))
    ...
    def reset(self):
        ...
        if self.episodes > 1:
            ...
            self.leftover_player_hp.append(sum(self.previous_player_hp))
